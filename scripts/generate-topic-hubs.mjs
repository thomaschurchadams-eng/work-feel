...
let failed=false;
const nav='<header><div class="container navbar"><a href="../index.html" class="brand"><img src="../assets/download.png" alt="CreditUnionAI News logo" class="brand-logo"></a><div class="nav-toggle" aria-label="Toggle navigation" role="button" tabindex="0"><span></span><span></span><span></span></div><nav class="nav-links"><a href="../index.html">Home</a><a href="/alerts/">AI Newsroom Alerts</a><a href="../news.html">News</a><a href="../insights.html">Insights</a><a href="../topics.html">Topics</a><a href="../intelligence/">Intelligence</a><a href="../newsletter.html">Subscribe</a><a href="../about.html">About</a></nav></div></header>';
